async function getLocationData(lat, lgn) {
    const url = `https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lgn}&=localityLanguage=en`
...
function getDistance(positions) {
    ...
    for (let i = 0; i < positions.length - 1; i++) {
        ...
        const deltaLatitude = toRadians(p2.latitude - p1.latitude)
        const deltaLongitude = toRadians(p2.longitude - p1.longitude)
